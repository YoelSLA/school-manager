...
@JsonSubTypes({
  @JsonSubTypes.Type(value = DesignacionLicenciaAdministrativaDTO.class, name = "ADMINISTRATIVA"),
  @JsonSubTypes.Type(value = DesignacionLicenciaCursoDTO.class, name = "CURSO")
})
