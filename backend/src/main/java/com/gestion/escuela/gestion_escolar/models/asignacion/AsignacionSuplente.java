...
public class AsignacionSuplente extends Asignacion {
  ...
  public void convertirseEnProvisional(LocalDate fechaDesde, Integer secuencia) {
    ...
    this.finalizarPorBajaDefinitiva(CausaBaja.PASE_A_PROVISIONAL, fechaFinSuplencia);

    getDesignacion()
        .cubrirConProvisionalAutomatico(this.getEmpleadoEducativo(), fechaDesde, secuencia);
  }
  ...
  public static class Builder {
    ...
    public AsignacionSuplente build() {
      return new AsignacionSuplente(empleadoEducativo, designacion, periodo, secuencia, licencia);
    }
  }
}
