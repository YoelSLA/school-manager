...
public interface MateriaRepository extends JpaRepository<Materia, Long> {
  ...
  boolean existsByEscuelaIdAndNombreIgnoreCaseAndIdNot(
      Long escuelaId, String nombre, Long materiaId);
  ...
  Optional<Materia> findByIdAndEscuelaId(Long materiaId, Long escuelaId);
}
