...
public interface CursoRepository extends JpaRepository<Curso, Long> {
  ...
  Page<Curso> findByEscuelaId(Long escuelaId, Pageable pageable);

  boolean existsByEscuelaIdAndAnioAndGradoAndTurnoAndIdNot(
      Long escuelaId, Integer anio, Integer grado, Turno turno, Long cursoId);

  boolean existsByEscuelaIdAndAnioAndGradoAndTurno(
      Long escuelaId, Integer anio, Integer grado, Turno turno);

  Page<Curso> findByEscuelaIdAndTurno(Long escuelaId, Turno turno, Pageable pageable);
