...
public class FranjaHoraria {
  ...
  public boolean seSuperponeCon(FranjaHoraria otra) {
    ...
    if (!esMismoDiaQue(otra)) return false;
  ...
  public String toString() {
    return String.format("%s %s → %s", dia, horaDesde, horaHasta);
  }

  private void validarCrear(DiaDeSemana dia, LocalTime horaDesde, LocalTime horaHasta) {
