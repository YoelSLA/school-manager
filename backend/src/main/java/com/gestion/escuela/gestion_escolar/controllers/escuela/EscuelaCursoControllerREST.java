...
import com.gestion.escuela.gestion_escolar.controllers.dtos.curso.response.CursoSelectDTO;
...
public class EscuelaCursoControllerREST {
  ...
  public CursoDetalleDTO crear(@PathVariable Long escuelaId, @Valid @RequestBody CursoDTO dto) {
  ...
  @PostMapping("/batch")
  @ResponseStatus(HttpStatus.CREATED)
  public void crearBatch(@PathVariable Long escuelaId, @RequestBody List<CursoDTO> cursosDTOs) {
    List<Curso> cursos = cursosDTOs.stream().map(CursoMapper::toEntity).toList();
  ...
  public CursoDetalleDTO actualizar(
      @PathVariable Long escuelaId, @PathVariable Long cursoId, @Valid @RequestBody CursoDTO dto) {
    Curso curso = cursoService.actualizar(escuelaId, cursoId, dto.anio(), dto.grado(), dto.turno());
  ...
  public void eliminar(@PathVariable Long escuelaId, @PathVariable Long cursoId) {
