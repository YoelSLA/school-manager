...
public record RegistrarInasistenciasManualDTO(
    @NotNull(message = "El empleadoEducativoBasico es obligatorio") Long empleadoId,
    ...
    @NotNull(message = "Debe indicar el tipo de licencia") LicenciaEstatutaria licenciaEstatutaria,
