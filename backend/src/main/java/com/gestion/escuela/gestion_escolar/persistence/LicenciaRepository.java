...
public interface LicenciaRepository extends JpaRepository<Licencia, Long> {
  ...
  @Query(
    ...
    """)
  Set<Long> buscarEmpleadosConLicenciaEn(@Param("fecha") LocalDate fecha);
  ...
  @Query(
    ...
    where a.id = :asignacionId
      and l.periodo.fechaDesde <= :fecha
      and l.periodo.fechaHasta >= :fecha
""")
  boolean existeLicenciaVigenteParaAsignacion(
      @Param("asignacionId") Long asignacionId, @Param("fecha") LocalDate fecha);
}
