...
public class AsistenciaMapper {
  ...
  public static AsistenciaDiaDTO toDiaDTO(EstadoAsistenciaDia estado) {
    ...
    return new AsistenciaDiaDTO(
        ...
        estado.getLicenciaEstatutaria() != null
            ? estado.getLicenciaEstatutaria().getCodigo()
            : null,
        estado.getLicencia() != null
            ? LicenciaMapper.toResumen(
                estado.getLicencia(), EstadoLicencia.CUBIERTA, estado.getFecha())
            : null);
  }

  public static AsistenciaEmpleadoResumenDTO toResumenDTO(
      EmpleadoEducativo empleado, EmpleadoAsistenciaResumen resumen) {
  ...
  private static OrigenAsistencia obtenerOrigen(EstadoAsistenciaDia estado) {
    if (estado.esManual()) {
