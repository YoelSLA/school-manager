...
public class PoliticaDeRenovacion {
  ...
  private PoliticaDeRenovacion() {}

  public static void validarRenovarProvisionalManual(
      AsignacionProvisional anterior, Periodo nuevoPeriodo) {
  ...
  public static void validarRenovarProvisionalDesdeMarzo(
      Asignacion asignacion, LocalDate fechaHasta) {
  ...
  public static void validarReglaCicloLectivo(Periodo periodo) {
    ...
    if (!hasta.isBefore(primeroDeMarzoSiguiente)) {
      throw new ReglaCicloLectivoException(
          "La fecha fin debe ser anterior al 1 de marzo del año siguiente");
    }
  }
}
