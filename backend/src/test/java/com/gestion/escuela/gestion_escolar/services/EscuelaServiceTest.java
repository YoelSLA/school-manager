...
class EscuelaServiceTest extends DomainServiceFixtureTest {
  ...
  //
  //		Escuela escuelaPersistida = escuelaService.crear(new Escuela("Escuela N°65", "Brown 5066",
  // "45674567"));
  //
  //		escuelaService.desactivarPorNombre(escuelaPersistida.getNombre());
  //
  //		assertThrows(EscuelaDuplicadaException.class, () -> escuelaService.crear(new Escuela("Escuela
  // N°65", "Otra", "9999")));
  //	}
  //
  //	// =========================
  ...
  //
  //		escuelaService.crear(escuelaACrear);
  //		Escuela escuelaADesactivar = escuelaService.crear(new Escuela("Escuela N°12", "San Martín
  // 123", "44112233")
  //		);
  //
  ...
  //
  //		// Given
  //		Escuela escuela = escuelaService.crear(new Escuela("Escuela N°12", "San Martín 123",
  // "44112233"));
  //
  //		escuelaService.desactivarPorNombre(escuela.getNombre());
  //
  ...
  //		);
  //
  //		Escuela escuelaActualizadaPersitida =
  // escuelaService.actualizarPorNombre(escuelaPersistida.getNombre(), escuelaAActualizar);
  //
