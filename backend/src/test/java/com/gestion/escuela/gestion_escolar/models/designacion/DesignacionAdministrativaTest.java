...
import com.gestion.escuela.gestion_escolar.models.DomainTestFixture;
...
class DesignacionAdministrativaTest extends DomainTestFixture {
  ...
  //      String cuil, String nombre, String apellido, LocalDate nacimiento, LocalDate ingreso) {
  ...
  //    return new Escuela("Escuela N°65", "Bernal", "Brown 5066", "42573309");
  //  }
  //
  //  private DesignacionAdministrativa crearDesignacionAdministrativa(
  //      Integer cupof, RolEducativo rolEducativo) {
  ...
  //    //
  //    //			assertEquals(EstadoDesignacion.CUBIERTA,
  // auxiliar2330001.getEstadoEn(fechaTomaPosesion));
  //    //		}
  //
  //    @Test
  ...
  //
  //      auxiliar2330001.registrarTitular(leguizamonMarina, fecha, 1);
  //
  //      assertThrows(
  //          DesignacionYaTieneTitularException.class,
  //          () -> auxiliar2330001.registrarTitular(vallejosValeria, fecha, 1));
  //    }
  //  }
  //
  //  @Nested
  ...
  //    //
  //    //			assertEquals(EstadoDesignacion.CUBIERTA,
  // direccion2467830.getEstadoEn(fechaTomaPosesion));
  //    //		}
  //
  //    @Test
  ...
  //
  //      direccion2467830.registrarTitular(leguizamonMarina, fechaTomaPosesion, 1);
  //
  //      assertThrows(
  //          DesignacionYaCubiertaException.class,
  //          () -> direccion2467830.cubrirConProvisionalManual(giardinoNoraRosa, periodoCerrado,
  // 1));
  //    }
  //
  //    @Test
  //    @DisplayName("Cobertura automática genera período hasta último día hábil de febrero
  // siguiente")
  ...
  //          direccion2467830.cubrirConProvisionalAutomatico(giardinoNoraRosa, inicio, 1);
  //
  ...
  //      LocalDate inicio = LocalDate.of(2024, 3, 1);
  //
  //      direccion2467830.registrarTitular(leguizamonMarina, inicio, 1);
  //
  //      assertThrows(
  //          DesignacionYaCubiertaException.class,
  //          () -> direccion2467830.cubrirConProvisionalAutomatico(giardinoNoraRosa, inicio, 1));
  ...
  //    //
  //    //			LocalDate fechaTomaPosesion = LocalDate.of(2004, Month.JULY, 21);
  //    //			AsignacionTitular titular = auxiliar2330001.cubrirConTitular(leguizamonMarina,
  //    // fechaTomaPosesion, 1);
  //    //
  ...
  //    //			// Arrange
  //    //			LocalDate fechaTomaPosesion = LocalDate.of(2004, Month.JULY, 21);
  //    //			AsignacionTitular asignacionTitular =
  // auxiliar2330001.cubrirConTitular(leguizamonMarina,
  //    // fechaTomaPosesion);
  //    //
  //    //			LocalDate fechaInicio = LocalDate.of(2025, Month.FEBRUARY, 24);
  //    //			LocalDate fechaFin = LocalDate.of(2026, Month.FEBRUARY, 4);
  ...
  //    //
  //    //			Licencia licencia = leguizamonMarina.crearLicencia(TipoLicencia.L_115D1, periodo,
  // "Reposo",
  ...
  //    //
  //    //			// Act
  //    //			AsignacionSuplente asignacionSuplente = auxiliar2330001.cubrirConSuplente(licencia,
  //    // vallejosValeria, fechaInicio);
  //    //
  //    //			// Assert
  ...
  //    @Test
  //    @DisplayName(
  //        "Renovación automática debe iniciar el 1 de marzo y finalizar el último día hábil de
  // febrero siguiente.")
  ...
  //      assertEquals(LocalDate.of(2019, Month.FEBRUARY, 28),
  ...
  //    @Test
  //    @DisplayName(
  //        "Renovación desde marzo debe iniciar el 1 de marzo y respetar la fecha fin indicada")
  ...
  //          direccion2467830.renovarProvisionalDesdeMarzo(anterior, nuevaFechaFin, 1);
  //
  //      // Assert
  //      assertNotNull(renovada);
  //      assertEquals(LocalDate.of(2018, Month.MARCH, 1), renovada.getPeriodo().getFechaDesde());
  ...
  //
  //    @Test
  //    @DisplayName("Renovación manual debe respetar las fechas indicadas cuando no hay
  // superposición")
  ...
  //          direccion2467830.cubrirConProvisionalManual(giardinoNoraRosa, periodoCerrado, 1);
  //
  //      Periodo nuevoPeriodoCerrado =
  //          cerrado(LocalDate.of(2018, Month.MARCH, 1), LocalDate.of(2018, Month.NOVEMBER, 30));
  //
  //      // Act
  //      AsignacionProvisional renovada =
  ...
  //
  //      assertThrows(CampoObligatorioException.class, () -> direccion2467830.setEscuela(null));
  //    }
  //
  //    @Test
  ...
  //
  //      Escuela nuevaEscuela = new Escuela("Escuela N°10", "Quilmes", "Calle Falsa 123",
  // "12345678");
  //
  ...
  //
  //      assertThrows(
  //          CampoObligatorioException.class, () -> direccion2467830.agregarFranjaHoraria(null));
  //    }
  //
  //    @Test
  ...
  //          new FranjaHoraria(DiaDeSemana.LUNES, LocalTime.of(8, 0), LocalTime.of(10, 0));
  //
  ...
  //    //
  //    //			AsignacionSuplente suplente = auxiliar2330001.cubrirConSuplente(licencia,
  // vallejosValeria,
  ...
  //    //			titular.finalizarPorBajaDefinitiva(CausaBaja.RENUNCIA_POR_CAUSAS_PARTICULARES,
  // fechaBaja);
  //    //
  //    //		}
  //
