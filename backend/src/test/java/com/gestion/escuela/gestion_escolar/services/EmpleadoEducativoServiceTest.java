...
class EmpleadoEducativoServiceTest extends DomainServiceFixtureTest {
  ...
  @BeforeEach
  void setUp() {
    p_escuelaN65 = escuelaService.crear(escuelaN65M);
    pGardinoNoraRosa = empleadoEducativoService.crear(p_escuelaN65.getId(), giardinoNoraRosaM);
    EmpleadoEducativo pbillordoTomasa =
        empleadoEducativoService.crear(p_escuelaN65.getId(), billordoTomasaM);
    EmpleadoEducativo pMarchettiRoman =
        empleadoEducativoService.crear(p_escuelaN65.getId(), marchettiRomanM);

    pDireccion2467830O = designacionCommandService.crear(direccion2467830M);

    materiaService.crear(p_escuelaN65.getId(), practicasDelLenguajeM);
    cursoService.crear(p_escuelaN65.getId(), a1g1M);
    p_plg2467775 = designacionCommandService.crear(plg2467775M);
  }
  ...
  class Creacion {
    ...
    void noSePuedeCrearUnEmpleadoSiLaEscuelaNoExiste() {
      assertThrows(
          ...
          () -> empleadoEducativoService.crear(999L, pGardinoNoraRosa));
    }

    @Test
    void noSePuedeCrearUnEmpleadoConCuilDuplicadoEnLaMismaEscuela() {
      EmpleadoEducativo duplicado =
      ...
      assertThrows(
          ...
          () -> empleadoEducativoService.crear(p_escuelaN65.getId(), duplicado));
    }
  ...
  class CreacionBatch {
    ...
    void creaMultiplesEmpleadosCorrectamente() {
      ...
      EmpleadoEducativo otroEmpleado =
          EmpleadoEducativo.builder()
              .escuela(p_escuelaN65)
              .cuil("20-22222222-2")
              .nombre("Maria")
  ...
  class ObtenerPorId {
    ...
    void lanzaExcepcionSiElEmpleadoNoExiste() {
      assertThrows(
          RecursoNoEncontradoException.class, () -> empleadoEducativoService.obtenerPorId(999L));
    }
  }
  ...
  //		AsignacionNormal asignacionTitular = cubrirConTitular(carlosFernandez, fechaTomaPosesion,
  // fechaCese);
  //
  ...
  //
  //		// Act
  //		empleadoEducativoService.darDeBajaDefinitiva(carlosFernandez.getId(), fechaBaja,
  // CausaBaja.RENUNCIA);
  //
  //		// Assert
  ...
  //		empleadoEducativoService.darDeBajaDefinitiva(mariaLopez.getId(), fechaBaja,
  // CausaBaja.RENUNCIA);
  //
  //		// Assert
  ...
  //
  //		AsignacionNormal asignacionTitular = cubrirConTitular(juanPerez, fechaTomaPosesion,
  // fechaCese);
  //
  ...
  //
  //		// Act
  //		empleadoEducativoService.darDeBajaDefinitiva(juanPerez.getId(), fechaBaja,
  // CausaBaja.RENUNCIA);
  //
  //		// Assert
  //		assertEquals(EstadoAsignacion.DADA_DE_BAJA, asignacionTitular.getEstadoEn(fechaBaja));
  ...
  //		);
  //
  //		//	designacionService.cubrirDesignacionesConSuplente(licenciaGuardada, mariaLopez,
  // List.of(bibliotecario.getId()));
  //
  //		// precondiciones
  //		LocalDate fechaBaja = LocalDate.of(2026, 1, 15);
  //
  ...
  //		Asignacion asignacionProvisional =
  // bibliotecario.asignacionQueEjerceEn(fechaBaja).orElseThrow();
