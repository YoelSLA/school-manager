...
class FranjaHorariaTest {
  ...
  class Creacion {
    ...
    void creaFranjaValida() {
      ...
      FranjaHoraria franja = new FranjaHoraria(DiaDeSemana.LUNES, desde, hasta);
    ...
    void fallaSiHoraDesdeEsNull() {
      ...
      assertThrows(
          CampoObligatorioException.class,
          () -> new FranjaHoraria(DiaDeSemana.LUNES, null, LocalTime.of(10, 0)));
    }
    ...
    void fallaSiHoraHastaEsNull() {
      ...
      assertThrows(
          CampoObligatorioException.class,
          () -> new FranjaHoraria(DiaDeSemana.LUNES, LocalTime.of(8, 0), null));
    }
    ...
    void fallaSiHorasIguales() {
      ...
      assertThrows(
          ...
          () -> new FranjaHoraria(DiaDeSemana.LUNES, LocalTime.of(8, 0), LocalTime.of(8, 0)));
    }
    ...
    void fallaSiRangoInvalido() {
      ...
      assertThrows(
          RangoHorarioInvalidoException.class,
          () -> new FranjaHoraria(DiaDeSemana.LUNES, LocalTime.of(10, 0), LocalTime.of(8, 0)));
    }
  }
  ...
  class ToStringTest {
    ...
    void muestraDiaYHorario() {
      ...
      assertEquals("LUNES 08:00 → 10:00", franja.toString());
    }
  }
}
