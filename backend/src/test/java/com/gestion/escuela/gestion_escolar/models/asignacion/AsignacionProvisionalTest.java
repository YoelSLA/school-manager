...
class AsignacionProvisionalTest {
  ...
  void setUp() {
    ...
    periodo = Periodo.cerrado(LocalDate.of(2025, 3, 1), LocalDate.of(2025, 3, 31));
  ...
  class Estado {
    ...
    void fallaSiFechaEsNull() {
      assertThrows(RuntimeException.class, () -> asignacion.getEstadoEn(null));
    }
    ...
    void estaActiva() {
      ...
      assertEquals(EstadoAsignacion.ACTIVA, asignacion.getEstadoEn(LocalDate.of(2025, 3, 10)));
    }
    ...
    void estaPendiente() {
      assertEquals(EstadoAsignacion.PENDIENTE, asignacion.getEstadoEn(LocalDate.of(2025, 2, 20)));
    }
    ...
    void estaFinalizada() {
      ...
      assertEquals(EstadoAsignacion.FINALIZADA, asignacion.getEstadoEn(LocalDate.of(2025, 4, 1)));
    }
    ...
    void estaActivaFalse() {
      ...
      assertFalse(asignacion.estaActivaEn(LocalDate.of(2025, 3, 10)));
    }
    ...
    void noEstaEnBajaSiFechaAnteriorALaBaja() {
      ...
      asignacion.finalizarPorBajaDefinitiva(CausaBaja.RENUNCIA, fechaBaja);

      when(empleado.estaEnLicenciaPara(any(), any())).thenReturn(false);

      EstadoAsignacion estado = asignacion.getEstadoEn(LocalDate.of(2025, 3, 10));
  ...
  class Baja {
    ...
    void noPermiteDobleBaja() {
      ...
      asignacion.finalizarPorBajaDefinitiva(CausaBaja.RENUNCIA, fecha);
    ...
    void causaBajaConValor() {
      ...
      assertEquals(CausaBaja.RENUNCIA, asignacion.getCausaBaja());
    }
  }
  ...
  class Cobertura {
    ...
    void noCubreFueraDelPeriodo() {
      ...
      assertFalse(asignacion.estaActivaEn(LocalDate.of(2025, 4, 10)));
    }
