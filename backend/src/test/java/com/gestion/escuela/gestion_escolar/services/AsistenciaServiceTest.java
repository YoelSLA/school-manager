...
class AsistenciaServiceTest extends DomainServiceFixtureTest {
  ...
  //	@BeforeEach
  //	void setUp() {
  //		pEscuelaN65 = escuelaService.crear(escuelaN65M);
  //		pGiardinoNoraRosa = empleadoEducativoService.crear(pEscuelaN65.getId(), giardinoNoraRosaM);
  //
  ...
  //				LocalTime.of(18,0)
  //		);
  //		direccion2467830M.agregarFranjaHoraria(martes12a18);
  //
  //		DesignacionAdministrativa pDireccion2467830 = designacionService.crear(direccion2467830M);
  //
