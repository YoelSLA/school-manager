...
class MateriaRestAssuredTest extends AbstractIntegrationTest {
  ...
  void flujoCompletoMateria() {
    ...
    EscuelaCreateDTO escuelaDTO =
        new EscuelaCreateDTO("Escuela N°66", "Bernal", "Brown 5066", "45674567");
    ...
    MateriaCreateDTO materiaDTO = new MateriaCreateDTO("Matemática", "MAT", 4);
    ...
    MateriaUpdateDTO updateDTO = new MateriaUpdateDTO("Matemática Avanzada", "MAT2", 5);
