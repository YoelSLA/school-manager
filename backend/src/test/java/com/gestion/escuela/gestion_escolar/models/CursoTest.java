...
class CursoTest {
  ...
  class CrearTest {
    ...
    void fallaSiTurnoEsNull() {
      ...
      assertThrows(CampoObligatorioException.class, () -> new Curso(null, 1, 3));
    }
    ...
    void fallaSiAnioEsNull() {
      ...
      assertThrows(CampoObligatorioException.class, () -> new Curso(MANIANA, null, 3));
    }
    ...
    void fallaSiGradoEsNull() {
      ...
      assertThrows(CampoObligatorioException.class, () -> new Curso(MANIANA, 1, null));
    }
    ...
    void fallaSiAnioEsInvalido(int anioInvalido) {
      ...
      assertThrows(AnioInvalidoException.class, () -> new Curso(MANIANA, anioInvalido, 3));
    }
    ...
    void fallaSiGradoEsInvalido(int gradoInvalido) {
      ...
      assertThrows(GradoInvalidoException.class, () -> new Curso(MANIANA, 1, gradoInvalido));
    }
    ...
    void creaCursoValido() {
      ...
      Curso curso = new Curso(MANIANA, 1, 3);
  ...
  class AsignarEscuelaTest {
    ...
    void fallaSiEscuelaEsNull() {
      ...
      assertThrows(CampoObligatorioException.class, () -> curso.setEscuela(null));
    }
  }
