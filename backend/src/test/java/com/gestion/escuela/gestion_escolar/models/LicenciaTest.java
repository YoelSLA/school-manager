...
class LicenciaTest extends DomainTestFixture {
  ...
  //	@BeforeEach
  //	void setUp() {
  //		licenciaEstatutaria = LicenciaEstatutaria.builder()
  //				.codigo("A1")
  //				.build();
  ...
  //		titular = plg2467775.registrarTitular(giardinoNoraRosa, fechaTomaPosesion, 1);
  //
  //	}
  //
  //	@Nested
  ...
  //			assertThat(licencia.getLicenciaEstatutaria()).isEqualTo(licenciaEstatutaria);
  ...
  //
  //			LocalDate fechaTomaPosesion = LocalDate.of(1998, FEBRUARY, 28);
  //			direccionTitular = direccion2467830.registrarTitular(giardinoNoraRosa, fechaTomaPosesion, 1);
  //
