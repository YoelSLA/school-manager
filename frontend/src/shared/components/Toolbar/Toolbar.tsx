	...
	return (
		<header className={styles.toolbar}>
			<div className={styles.toolbar__header}>
				<div className={styles.toolbar__title}>{title}</div>

				<div className={styles.toolbar__headerCenter}>{headerCenter}</div>
			...
			<div className={styles.toolbar__footer}>{footer}</div>
		</header>
	);
}
