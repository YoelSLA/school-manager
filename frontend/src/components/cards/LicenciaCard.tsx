...
type Props = {
  licencia: LicenciaResponseDTO;
};

export function LicenciaCard({ licencia }: Props) {
  const [mostrarTipo, setMostrarTipo] = useState(false);
  const [flipped, setFlipped] = useState(false);

  const estadoLicencia = licencia.activa
    ? licencia.cubierta
      ? "activa"
      : "pendiente"
    : "finalizada";
        ...
        >
          ...
          <div className="section-top">
            ...
            <div className={`estado ${estadoLicencia}`}>
              ...
              {estadoLicencia === "pendiente" && icons.alert}
