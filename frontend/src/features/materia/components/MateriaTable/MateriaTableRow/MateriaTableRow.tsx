...
import styles from "./MateriaTableRow.module.scss";
...
export default function MateriaTableRow({ materia, onEdit, onDelete }: Props) {
	return (
		<TableRow className={styles.row}>
			<div className={styles.nombre}>{materia.nombre}</div>

			<div className={styles.abreviatura}>{materia.abreviatura}</div>

			<div className={styles.modulos}>{materia.cantidadModulos} módulos</div>
