...
import {
	useDesignacionAdministrativaCreate,
	useDesignacionCursoCreate,
} from "../mutations";
...
export function useDesignacionPageCreate() {
	...
	const crearCurso = useDesignacionCursoCreate(escuelaActiva?.id);
	const crearAdministrativa = useDesignacionAdministrativaCreate(
		escuelaActiva?.id,
	);
