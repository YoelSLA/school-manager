...
import { DesignacionAsignacionActiva, DesignacionCargosHistorial, DesignacionDatos, DesignacionDetalleActions, DesignacionDetalleModals, DesignacionHeaderInfo, DesignacionHorarios } from "../../components/DesignacionPageDetalle";
import { useDesignacionPageDetail } from "../../hooks/pages";

import styles from "./DesignacionDetallePage.module.scss";

export default function DesignacionPageDetalle() {
  const vm = useDesignacionPageDetail();
