...
import type { DesignacionAdministrativaDetalleDTO, DesignacionAdministrativaUpdateDTO } from "@/features/designaciones/types/designacion.types";
...
export default function DesignacionAdministrativaUpdateForm({
  designacion,
  onSubmit,
  isSubmitting,
}: Props) {
