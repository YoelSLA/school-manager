      ...
      {designacion.asignacionActiva ? (
        <>
          <div className={styles.person}>
            ...
            <div>
              ...
              <span>
                {" "}
                {designacion.asignacionActiva.empleado.cuil}
              </span>
            </div>
          </div>
          ...
          <div className={styles.meta}>
            <div className={styles.periodo}>
              ...
              <div className={styles.periodo__content}>
                ...
                <strong>
                  {formatearFecha(designacion.asignacionActiva.periodo.fechaDesde)} ➡️{" "}
                  {formatearFecha(designacion.asignacionActiva.periodo.fechaHasta!)}
                </strong>
              </div>
            </div>
          </div>
        ...
        <div className={styles.empty}>
          ...
          <div>
            ...
            <span>
              Todavía no hay ningún empleado cubriendo esta
              designación.
            </span>
          </div>
        </div>
