...
type Props = {
  ...
  onTitularSubmit: (data: CubrirTitularFormValues & { empleadoId: number }) => Promise<void>;
  onProvisionalSubmit: (data: CubrirProvisionalFormValues & { empleadoId: number }) => Promise<void>;
