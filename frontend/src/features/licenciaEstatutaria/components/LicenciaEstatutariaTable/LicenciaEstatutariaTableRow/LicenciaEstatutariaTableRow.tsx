...
import styles from "./LicenciaEstatutariaTableRow.module.scss";
...
export default function LicenciaEstatutariaRow({
	...
	return (
		<TableRow className={styles.row}>
			<div className={styles.articulo}>{licenciaEstatutaria.articulo}</div>

			<div className={styles.codigo}>{licenciaEstatutaria.codigo}</div>
			...
			<div className={styles.estado}>
				<span
					className={`${styles.badge} ${
						licenciaEstatutaria.activa ? styles.activa : styles.inactiva
					}`}
				>
