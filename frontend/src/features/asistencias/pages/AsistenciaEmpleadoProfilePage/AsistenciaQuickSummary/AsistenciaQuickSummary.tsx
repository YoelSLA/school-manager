...
export default function AsistenciaQuickSummary({ empleadoId }: Props) {
	...
	return (
		<section className={styles.card}>
			...
			<div className={styles.highlight}>
				<span className={styles.highlight__label}>Mes con más faltas</span>

				<strong className={styles.highlight__value}>Febrero (5)</strong>
			</div>
