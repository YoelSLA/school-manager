...
import { useAsistenciasEmpleadoMes } from "./useAsistenciasEmpleadoMes";
import { useEliminarInasistenciasManual } from "./useEliminarInasistenciasManual";
import { useRegistrarInasistenciasManual } from "./useRegistrarInasistenciasManual";
...
export default function useAsistenciaDetallePage() {
	 ...
	 * REGISTER MUTATION
	 * =======================================================*/
	const { mutate: registrarAsistencia, isPending } =
