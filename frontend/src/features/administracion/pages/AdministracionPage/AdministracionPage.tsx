	...
	return (
		<div className={styles.page}>
			<header className={styles.header}>
				...
				<p>Gestione catálogos, documentos y configuraciones del sistema.</p>
			</header>
			...
			<section className={styles.section}>
				...
				<div className={styles.grid}>
					<button
						...
						onClick={() => navigate("/administracion/licencias-estatutarias")}
					>
						...
						<div className={styles.cardBody}>
							...
							<p>Administre las licencias definidas por el Estatuto Docente.</p>
						</div>
